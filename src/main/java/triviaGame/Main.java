...
public class Main {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        String API_URL = "https://opentdb.com/api.php?amount=11&category=9&type=multiple";

        // Building a "GET" request.
        HttpRequest request = HttpRequest.newBuilder()
                .GET() //This line is technically unnecessary because the default request is a GET request but leaving for readability of code purposes.
